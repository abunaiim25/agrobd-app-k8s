        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item   {{ Request::is('my_business') ? 'active' : '' }}">
                    <a class="nav-link " aria-current="page" href="{{ url('my_business') }}">Products</a>
                </li>

                <li class="nav-item   {{ Request::is('shop') ? 'active' : '' }}">
                    <a class="nav-link " aria-current="page" href="{{ url('shop') }}">Admin Products</a>
                </li>

                <li class="nav-item   {{ Request::is('business_profile') ? 'active' : '' }}">
                    <a class="nav-link " aria-current="page" href="{{ url('business_profile') }}">Business Profile</a>
                </li>
                ...
                <li class="nav-item   {{ Request::is('cart') ? 'active' : '' }}">
                    <a href="{{ url('cart') }}" class="nav-link " aria-current="page"><i class="fal fa-shopping-bag">
                            <small>{{ $quantity }}</small></i></a>
                </li>
